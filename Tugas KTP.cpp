...
void pilihGender(string &gender){
	int pilihan;
	cout << "Pilih Gender:\n";
	cout << "1.Laki-laki:\n";
	cout << "2.Perempuan:\n";
	...
	switch (pilihan){
		...
		default:
			cout << "Pilihan gender tidak valid.Gender diatur ke 'Tidak Diketahui'.\n";
...
void pilihStatusperkawinan(string &statusperkawinan) {
    int pilihan;
    cout << "Pilih Status Perkawinan:\n";
    cout << "1. Belum Kawin\n";
    cout << "2. Kawin\n";
    cout << "3. Cerai Hidup\n";
    cout << "4. Cerai Mati\n";
    ...
    switch (pilihan) {
        ...
        default:
            cout << "Pilihan status kawin tidak valid. Status kawin diatur ke 'Tidak Diketahui'.\n";
            statusperkawinan = "Tidak Diketahui";
            break;
    }
}

void pilihKewarganegaraan(string &kewarganegaraan) {
    int pilihan;
    cout << "Pilih Kewarganegaraan:\n";
    ...
    switch (pilihan) {
        case 1: kewarganegaraan = "Warga Negara Indonesia"; break;
        case 2: kewarganegaraan = "Warga Negara Asing"; break;
        default:
            cout << "Pilihan kewarganegaraan tidak valid. Kewarganegaraan diatur ke 'Tidak Diketahui'.\n";
            kewarganegaraan = "Tidak Diketahui";
            break;
    }
}
void inputBerlakuHingga(string &berlaku_hingga) {
    cout << "Masukkan Berlaku Hingga (format: YYYY-MM-DD): ";
...
void inputKTP(KTP &ktp) {
    ...
    cout << "Masukkan Jenis Kelamin(Laki-laki/Perempuan): "; getline(cin, ktp.jenis_kelamin);
